...
export default function TabletApp() {
  return (
    <div className="min-h-screen bg-[#FAF6F0] text-petruzzi-950 flex flex-col font-sans">
      ...
      {/* Top Banner Navigation for Tablet Station */}
      <header className="bg-white border-b border-petruzzi-200 px-4 sm:px-6 py-3 flex items-center justify-between shadow-sm sticky top-0 z-40">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <span className="text-[10px] font-extrabold text-petruzzi-700 uppercase tracking-widest block mt-0.5">
              📱 POSTAZIONE TABLET CONFEZIONAMENTO LABORATORIO
            </span>
          </div>
        </div>
      ...
      {/* Main Tablet Packaging Interface */}
